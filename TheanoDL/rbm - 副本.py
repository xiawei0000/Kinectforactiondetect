...
class RBM(object):
    ...
    def free_energy(self, v_sample):#求能量，矩阵的形式 没看懂
    ...
    def propup(self, vis):#可视化层输入，得到输出层值
    ...
    def sample_h_given_v(self, v0_sample):#根据隐藏层的概率，进行采样得到的结果。
    ...
    def gibbs_hvh(self, h0_sample):#联合两次采样：先
